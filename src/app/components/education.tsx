        ...
        <div className="space-y-6">
          {educationData.map((edu, index) => (
            <a
              ...
              className="block"
            >
              <div className="bg-white dark:bg-[#2f2f2f] text-black dark:text-white p-6 rounded-xl shadow-md border-l-4 border-cyan-400 transition-transform duration-300 hover:shadow-[0_0_15px_rgba(0,255,255,0.7)] hover:scale-[1.01]">
