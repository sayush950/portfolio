...
export default function Contact() {
  ...
  return (
    <div id="contact" className="min-h-[80vh] flex flex-col justify-between">
      ...
      <div className="flex justify-between items-start px-8 md:px-10 pb-0 flex-wrap lg:m-10 lg:mb-4">
        <div className="w-1/2 md:w-auto">
          <p className="bg-pink-600 text-white px-4 py-1 inline-block mb-2 font-bold">AYUSH SINGH</p><br />
          <p className="bg-pink-600 text-white px-4 py-1 inline-block font-bold">A FULL-STACK DEVELOPER</p>
        </div>
        <div className="w-1/2 md:w-auto text-right">
          <p className="font-semibold text-[15px] underline-offset-2 mb-2">You can find me here ✌️</p>
